package com.ivan.messenger.ui.widget.fab;
...
public class FloatingActionMenu extends ViewGroup {
    ...
    private int mButtonSpacing = CommonUtils.dip2px(getContext(), 0f);
    private FloatingActionButton mMenuButton;
    private int mMaxButtonWidth;
    private int mLabelsMargin = CommonUtils.dip2px(getContext(), 0f);
    private int mLabelsVerticalOffset = CommonUtils.dip2px(getContext(), 0f);
    ...
    private int mLabelsPaddingTop = CommonUtils.dip2px(getContext(), 4f);
    private int mLabelsPaddingRight = CommonUtils.dip2px(getContext(), 8f);
    private int mLabelsPaddingBottom = CommonUtils.dip2px(getContext(), 4f);
    private int mLabelsPaddingLeft = CommonUtils.dip2px(getContext(), 8f);
    private ColorStateList mLabelsTextColor;
    private float mLabelsTextSize;
    private int mLabelsCornerRadius = CommonUtils.dip2px(getContext(), 3f);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (mLabelsTextColor == null) {
            mLabelsTextColor = ColorStateList.valueOf(Color.BLACK);
        }
        ...
        if (mIcon == null) {
            mIcon = getResources().getDrawable(R.drawable.ic_add_white_24dp);
        }
    ...
    private void createMenuButton() {
        ...
        if (mMenuShowShadow) {
            mMenuButton.mShadowRadius = CommonUtils.dip2px(getContext(), mMenuShadowRadius);
            mMenuButton.mShadowXOffset = CommonUtils.dip2px(getContext(), mMenuShadowXOffset);
            mMenuButton.mShadowYOffset = CommonUtils.dip2px(getContext(), mMenuShadowYOffset);
        }
